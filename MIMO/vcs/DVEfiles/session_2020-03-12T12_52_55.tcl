...
# DVE full session
# Saved on Thu Mar 12 12:52:54 2020
# Designs open: 1
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 502]
...
gui_set_window_pref_key -window ${HSPane.1} -key dock_width -value_type integer -value 502
gui_set_window_pref_key -window ${HSPane.1} -key dock_height -value_type integer -value -1
gui_set_window_pref_key -window ${HSPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 501} {height 377} {dock_state left} {dock_on_new_line true} {child_hier_colhier 342} {child_hier_coltype 155} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 500} {height 377} {dock_state left} {dock_on_new_line true} {child_data_colvariable 222} {child_data_colvalue 180} {child_data_coltype 120} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1534} {height 363} {dock_state bottom} {dock_on_new_line true}}
