...
# DVE full session
# Saved on Tue Apr 14 19:07:03 2020
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{715 51} {1633 1019}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 354} {height 629} {dock_state left} {dock_on_new_line true} {child_hier_colhier 342} {child_hier_coltype 155} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 353} {height 629} {dock_state left} {dock_on_new_line true} {child_data_colvariable 222} {child_data_colvalue 180} {child_data_coltype 120} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 217]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 919
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 217
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 918} {height 216} {dock_state bottom} {dock_on_new_line true}}
